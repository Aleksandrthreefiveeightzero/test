...
function vdz_cb_activate_plugin(){
    ...
    add_option( 'vdz_cb_test_settings', array(
...
function vdz_cb_menu() {
    add_options_page( __( 'VDZ Call Back Settings Page', 'vdz_call_back' ), __( 'VDZ Call Back', 'vdz_call_back' ), 'manage_options', 'vdz_call_back', 'vdz_call_back_settings_page' );
...
//    exit;
    ...
    add_settings_error( 'vdz_cb_plugin_settings', 'settings_updated', __( 'Plugin Settings UPDATED', 'vdz_call_back' ), 'updated' );
...
function vdz_call_back_popup_settings_sanitize($input){
    ...
    //Добавляем вывод сообщения при успешном сохранении
    add_settings_error( 'vdz_cb_popup_settings', 'settings_updated', __( 'Popup Settings UPDATED', 'vdz_call_back' ), 'updated' );
...
function vdz_call_back_test_settings_sanitize($input){
    ...
    //Добавляем вывод сообщения при успешном сохранении
    add_settings_error( 'vdz_cb_test_settings', 'settings_updated', __( 'TEST Settings UPDATED', 'vdz_call_back' ), 'updated' );
...
function vdz_call_back_settings_page(){
    ...
    echo $vdz_cb_admin_view_obj->render('layout_settings_page', array(
...
//        echo get_admin_url();
        $settings_link = '<a href="' . get_admin_url() . 'options-general.php?page=vdz_call_back">'.__('Settings').'</a>';
