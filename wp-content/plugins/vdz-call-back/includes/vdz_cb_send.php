...
function vdz_cb_send(){
    ...
    $email_subject = (isset($vdz_cb_plugin_settings['vdz_cb_plugin_custom_mail_subject']) && !empty($vdz_cb_plugin_settings['vdz_cb_plugin_custom_mail_subject'])) ? $vdz_cb_plugin_settings['vdz_cb_plugin_custom_mail_subject'] : __( 'Call back', 'vdz_call_back' );
