...
function vdz_cb_shortcode($atts, $content) {
    ...
    $attributes = shortcode_atts( array(
        'vdz_cb_popup_title' => __( 'Call back', 'vdz_call_back' ),
        'vdz_cb_popup_mask' => '(999) 999-99-99',
        'vdz_cb_popup_mask_off' => 0,
        'vdz_cb_popup_name' => __( 'Name', 'vdz_call_back' ),
        'vdz_cb_popup_name_required' => 0,
        'vdz_cb_popup_phone' => __( 'Phone', 'vdz_call_back' ),
        'vdz_cb_popup_text' => '',
        'vdz_cb_popup_custom_fields' => '',
        'vdz_cb_popup_button' => __( 'Send', 'vdz_call_back' ),
        'vdz_cb_popup_error' => __( 'Error', 'vdz_call_back' ),
        'vdz_cb_popup_success' => __( 'Thank you!', 'vdz_call_back' ),
        'vdz_cb_popup_button_class' => '',
        'vdz_cb_popup_action_button_class' => '',
        'vdz_cb_popup_button_open' => !empty($content) ? $content : __( 'Call back', 'vdz_call_back' ),
    ), $atts );
