...
{
    wp_register_style('magnific-popup', VDZ_CALL_BACK_URL . 'assets/magnific-popup/magnific-popup.css');
...
function vdz_cb_js(){
    wp_register_script('jquery.magnific-popup',  VDZ_CALL_BACK_URL . 'assets/magnific-popup/jquery.magnific-popup.min.js', array('jquery'));
    wp_enqueue_script('jquery.magnific-popup');
    wp_register_script('jquery.maskedinput',  VDZ_CALL_BACK_URL . 'assets/js/jquery.maskedinput.min.js', array('jquery'));
    wp_enqueue_script('jquery.maskedinput');
    wp_register_script('vdz_call_back',  VDZ_CALL_BACK_URL . 'assets/js/vdz_call_back.js', array('jquery'));
    wp_enqueue_script('vdz_call_back');
